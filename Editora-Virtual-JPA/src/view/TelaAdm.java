...
public class TelaAdm extends JFrame {
	...
	public TelaAdm() {
		...
		final Object [] dadosCat = new Object[2]; 
		try {
		...
		btnVisLivrosCat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int id = (Integer) modeltablecat.getValueAt(selecteRowdIdx, 0);
		...
		final Object [] dadosArea = new Object[3];
		...
		btnVisLivrosArea.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int id = (Integer) modeltablearea.getValueAt(selecteRowdIdx, 0);
		...
		final Object [] dadosEditora = new Object[5];
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (i == JOptionPane.YES_OPTION) {
						...
						try {
							...
							int id = (Integer) modeltableedit.getValueAt(selecteRowdIdx, 0);
